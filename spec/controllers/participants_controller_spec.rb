  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved participant as @participant" do
        ...
        post :create, {:participant => { "project_id" => "invalid value" }}, valid_session
        assigns(:participant).should be_a_new(Participant)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested participant" do
        ...
        Participant.any_instance.should_receive(:update_attributes).with({ "project_id" => "1" })
        put :update, {:id => participant.to_param, :participant => { "project_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the participant as @participant" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Participant.any_instance.stub(:save).and_return(false)
        put :update, {:id => participant.to_param, :participant => { "project_id" => "invalid value" }}, valid_session
        assigns(:participant).should eq(participant)
      end
